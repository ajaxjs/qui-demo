...
function useRouterLink({ fallbackTag, useDisableForRouterLinkProps = true } = {}) {
  ...
  const hasRouter = uni_modules_kvQui_utils_private_vm.vmHasRouter(vm);
  const hasHrefLink = common_vendor.computed$1(() => props.disable !== true && props.href !== void 0);
  const hasRouterLinkProps = useDisableForRouterLinkProps === true ? common_vendor.computed$1(
  ...
  const resolvedLink = common_vendor.computed$1(() => hasRouterLinkProps.value === true ? getLink(props.to) : null);
  const hasRouterLink = common_vendor.computed$1(() => resolvedLink.value !== null);
  const hasLink = common_vendor.computed$1(() => hasHrefLink.value === true || hasRouterLink.value === true);
  const linkTag = common_vendor.computed$1(() => props.type === "a" || hasLink.value === true ? "a" : props.tag || fallbackTag || "div");
  const linkAttrs = common_vendor.computed$1(() => hasHrefLink.value === true ? {
    href: props.href,
    target: props.target
  ...
  const linkActiveIndex = common_vendor.computed$1(() => {
  ...
  const linkClass = common_vendor.computed$1(() => hasRouterLink.value === true ? linkIsExactActive.value === true ? ` ${props.exactActiveClass} ${props.activeClass}` : props.exact === true ? "" : linkIsActive.value === true ? ` ${props.activeClass}` : "" : "");
  function getLink(to) {
    try {
...
exports.useRouterLink = useRouterLink;
exports.useRouterLinkProps = useRouterLinkProps;
