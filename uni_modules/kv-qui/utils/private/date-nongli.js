/*
* https://github.com/jjonline/calendar.js/blob/master/dist/js-calendar-converter.mjs
*/
...
var ChineseZodiac = ["\u9F20", "\u725B", "\u864E", "\u5154", "\u9F99", "\u86C7", "\u9A6C", "\u7F8A", "\u7334", "\u9E21",
	"\u72D7", "\u732A"
];
...
var calendar = {
	...
	solar2lunar: function solar2lunar(yPara, mPara, dPara) {
		...
		return {
			...
			'LunarMonth': month,
			'LunarDay': day,
			'Zodiac': this.getAnimal(year),
			'LunarMonthZh': (isLeap ? "\u95F0" : '') + this.toChinaMonth(month),
			'LunarDayZh': this.toChinaDay(day),
			'SolarYear': y,
			'SolarMonth': m,
			'SolarDay': d,
			'ganzhiYear': gzY,
