...
if (!Array) {
  ...
  (_easycom_q_btn2 + _easycom_q_checkbox2 + _easycom_q_header2 + _easycom_q_tab2 + _easycom_q_tabs2 + _easycom_q_footer2 + _easycom_q_page2 + _easycom_q_drawer2)();
}
...
if (!Math) {
  (_easycom_q_btn + _easycom_q_checkbox + _easycom_q_header + _easycom_q_tab + _easycom_q_tabs + _easycom_q_footer + _easycom_q_page + _easycom_q_drawer)();
}
const _sfc_main = {
  __name: "layout",
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        k: common_vendor.o(($event) => showLeftSide.value = !showLeftSide.value),
        l: common_vendor.p({
          flat: true,
          icon: "menu"
        }),
        m: common_vendor.o(($event) => showRightSide.value = !showRightSide.value),
        n: common_vendor.p({
          flat: true,
          icon: "menu"
        }),
        ...
        x: common_vendor.o(($event) => showLeftSide.value = $event),
        y: common_vendor.p({
          elevated: true,
        ...
        z: common_vendor.o(($event) => showRightSide.value = $event),
        A: common_vendor.p({
          elevated: true,
          overlay: isOverlay.value,
          persistent: isPersistent.value,
