<template>
	<q-page containerClass="q-pa-sm">
		<view class="lm-title q-mb-md">基础卡片</view>
		<q-card className="my-card">
			<q-card-section>
				{{ lorem }}
			</q-card-section>
		</q-card>
		<q-card className="my-card text-white" styles="background: radial-gradient(circle, #35a2ff 0%, #014a88 100%)">
			<q-card-section>
		...
		<q-card flat bordered className="my-card">
			<q-card-section>
				<div class="text-h6">Our Changing Planet</div>
			</q-card-section>
				<q-card-section class="q-pt-none">
		...
		<view class="lm-title q-mb-md">带操作的卡片</view>
		...
		<q-card className="my-card bg-purple text-white">
			<q-card-section>
				<div class="text-h6">Our Changing Planet</div>
				<div class="text-subtitle2">by John Doe</div>
			</q-card-section>
		...
		<view class="lm-title q-mb-md">水平排版</view>
		<q-card className="my-card" flat bordered>
		...
		<view class="lm-title q-mb-md">带媒体内容</view>
		<q-card className="my-card">
