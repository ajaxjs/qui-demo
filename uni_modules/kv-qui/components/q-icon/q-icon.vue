<template>
	<view :class="[classes,className]" :style="[sizeStyle,styles]" :aria-hidden="true" role="presentation">
		<img v-if="type.img" :src="type.src" />
		<text v-else :class="type.cls">{{type.content||''}}</text>
		<slot></slot>
	</view>
</template>
