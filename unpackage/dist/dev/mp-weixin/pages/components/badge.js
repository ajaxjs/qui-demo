...
if (!Array) {
  ...
  (_easycom_q_badge2 + _easycom_q_icon2 + _component_Lanmu + _easycom_q_separator2 + _easycom_q_btn2)();
}
...
if (!Math) {
  (_easycom_q_badge + _easycom_q_icon + _easycom_q_separator + _easycom_q_btn)();
}
